...
- (nullable NSString *)getStringForKey:(nonnull NSString *)key
                                 error:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(string(forKey:));
...
- (nonnull NSString *)getStringForKey:(nonnull NSString *)key
                         defaultValue:(nonnull NSString *)defaultValue NS_SWIFT_NAME(string(forKey:defaultValue:));
 ...
 * @return `YES` on success, otherwise `NO`.
 */
- (BOOL)setString:(nonnull NSString *)value forKey:(nonnull NSString *)key
            error:(NSError * _Nullable * _Nullable)error;
 ...
 * @return the value.
 */
- (BOOL)getBooleanForKey:(nonnull NSString *)key defaultValue:(BOOL)defaultValue NS_SWIFT_NAME(boolean(forKey:defaultValue:));
 ...
 * @return `YES` on success, otherwise `NO`.
 */
- (BOOL)setBoolean:(BOOL)value forKey:(nonnull NSString *)key
             error:(NSError * _Nullable * _Nullable)error;
 ...
 * @return the value.
 */
- (double)getNumberForKey:(nonnull NSString *)key defaultValue:(double)defaultValue NS_SWIFT_NAME(number(forKey:defaultValue:));
 ...
 * @return `YES` on success, otherwise `NO`.
 */
- (BOOL)setNumber:(double)value forKey:(nonnull NSString *)key
            error:(NSError * _Nullable * _Nullable)error;
...
- (nullable IINKParameterSet *)getSectionForKey:(nonnull NSString *)key
                                          error:(NSError * _Nullable * _Nullable)error NS_SWIFT_NAME(section(forKey:));
