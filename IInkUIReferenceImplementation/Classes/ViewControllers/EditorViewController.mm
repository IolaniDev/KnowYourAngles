...
- (void)loadView
{
    ...
    self.inputView.inputView.layer.borderColor = UIColor.blackColor.CGColor;
    self.inputView.inputView.layer.borderWidth = 1;
...
- (void)initSmartGuideViewController
{
    ...
    //calls the method addChildVieController
